...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _model_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/Search */ \"./src/js/model/Search.js\");\n/* harmony import */ var _model_City__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model/City */ \"./src/js/model/City.js\");\n/* harmony import */ var _view_searchView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/searchView */ \"./src/js/view/searchView.js\");\n/* harmony import */ var _view_render__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/render */ \"./src/js/view/render.js\");\n/* harmony import */ var _view_base__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view/base */ \"./src/js/view/base.js\");\n/* harmony import */ var _udemy_complete_javascript_course_master_9_forkify_final_src_js_views_searchView__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../udemy/complete-javascript-course-master/9-forkify/final/src/js/views/searchView */ \"../../udemy/complete-javascript-course-master/9-forkify/final/src/js/views/searchView.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nlet pageData = JSON.parse(window.localStorage.getItem('data'));\r\n\r\n\r\nconst state = {};\r\n\r\nconst page = (pageData) => {\r\n  if (!pageData) {\r\n    controlSearch();\r\n  } else {\r\n    _view_render__WEBPACK_IMPORTED_MODULE_3__[\"renderResult\"](pageData);\r\n  }\r\n}\r\n\r\n_view_searchView__WEBPACK_IMPORTED_MODULE_2__[\"clearResults\"]();\r\npage(pageData);\r\n\r\nconst controlSearch = async () => {\r\n  // 1) Get query from view\r\n  const query = _view_searchView__WEBPACK_IMPORTED_MODULE_2__[\"getInput\"]();\r\n  // 2) New search\r\n  if (query) {\r\n    let searchQuery;\r\n    switch (query) {\r\n      case 'poland':\r\n        searchQuery = 'PL';\r\n        break;\r\n      case 'spain':\r\n        searchQuery = 'ES';\r\n        break;\r\n      case 'france':\r\n        searchQuery = 'FR';\r\n        break;\r\n      case 'germany':\r\n        searchQuery = 'DE';\r\n        break;\r\n      default:\r\n        alert('COUNTRY ERROR');\r\n    }\r\n    state.search = new _model_Search__WEBPACK_IMPORTED_MODULE_0__[\"default\"](searchQuery);\r\n    // 3) Prepare UI for results\r\n    _view_searchView__WEBPACK_IMPORTED_MODULE_2__[\"clearResults\"]();\r\n    // 4) Search for cities\r\n    try {\r\n      await state.search.getCities();\r\n      console.table(state.search.result);\r\n    } catch (error) {\r\n      console.log('ERROR A:', error)\r\n    }\r\n    state.cities = new _model_City__WEBPACK_IMPORTED_MODULE_1__[\"default\"](state.search.result, searchQuery);\r\n    try {\r\n      await state.cities.getDescr();\r\n      console.table(state.search.result);\r\n    } catch (err) {\r\n      console.log('ERROR B:', err)\r\n    }\r\n\r\n    // 5) Render results on UI\r\n    _view_render__WEBPACK_IMPORTED_MODULE_3__[\"renderResult\"](state.search.result);\r\n\r\n    // 6) Put result to localstorage\r\n    window.localStorage.setItem('data', JSON.stringify(state.search.result));\r\n    console.log(state.search.result);\r\n  }\r\n\r\n}\r\n\r\n_view_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].input.addEventListener('keypress', e => {\r\n  if (e.keyCode === 13) controlSearch();\r\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");

/***/ }),

/***/ "./src/js/model/City.js":
/*!******************************!*\
  !*** ./src/js/model/City.js ***!
  \******************************/
...
/*!***********************************!*\
  !*** ./src/js/view/searchView.js ***!
  \***********************************/
/*! exports provided: getInput, clearResults */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getInput\", function() { return getInput; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearResults\", function() { return clearResults; });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\r\nconst countries = ['Poland', 'Germany', 'Spain', 'France'];\r\n\r\nconst autocomplete = (input, countries) => {\r\n  let currentFocus;\r\n  input.addEventListener('input', e => {\r\n    const value = undefined.value;\r\n    let el, elText;\r\n    closeAllLists();\r\n\r\n    document.createElement('div');\r\n    el.setAttribute(\"id\", undefined.id + \"autocomplete-list\");\r\n    el.setAttribute('class', 'autocomplete-items');\r\n    undefined.parentNode.appendChild(el);\r\n    for (let i = 0; i < countries.length; i++) {\r\n      if (countries[i].substr(0, value.length).toUpperCase() == value.toUpperCase()) {\r\n        elText = document.createElement('div');\r\n        elText.innerHTML = `<strong> ${countries[i].substr(0, value.length)} </strong>`;\r\n        elText.innerHTML += countries[i].substr(value.length);\r\n        elText.innerHTML += `<input type=\"hidden\" value=\"${countries[i]}\">`;\r\n        elText.addEventListener('click', e => {\r\n          input.value = undefined.getElementsByTagName(\"input\")[0].value;\r\n          closeAllLists();\r\n        });\r\n        el.appendChild(elText);\r\n      }\r\n    }\r\n  });\r\n  inp.addEventListener(\"keydown\", e => {\r\n    let x = document.getElementById(undefined.id + \"autocomplete-list\");\r\n    if (x) x = x.getElementsByTagName(\"div\");\r\n    if (e.keyCode == 40) {\r\n      currentFocus++;\r\n      addActive(x);\r\n    } else if (e.keyCode == 38) {\r\n      currentFocus--;\r\n      addActive(x);\r\n    } else if (e.keyCode == 13) {\r\n      // e.preventDefault();\r\n      if (currentFocus > -1) {\r\n        if (x) x[currentFocus].click();\r\n      }\r\n    }\r\n  });\r\n  const addActive = x => {\r\n    if (!x) return false;\r\n    removeActive(x);\r\n    if (currentFocus >= x.length) currentFocus = 0;\r\n    if (currentFocus < 0) currentFocus = (x.length - 1);\r\n    x[currentFocus].classList.add(\"autocomplete-active\");\r\n  }\r\n  const removeActive = x => {\r\n    for (var i = 0; i < x.length; i++) {\r\n      x[i].classList.remove(\"autocomplete-active\");\r\n    }\r\n  }\r\n  const closeAllLists = element => {\r\n    const x = document.getElementsByClassName(\"autocomplete-items\");\r\n    for (let j = 0; j < x.length; j++) {\r\n      if (element != x[j] && element != inp) {\r\n        x[j].parentNode.removeChild(x[j]);\r\n      }\r\n    }\r\n  }\r\n\r\n  document.addEventListener(\"click\", e => {\r\n    closeAllLists(e.target);\r\n  });\r\n}\r\n\r\nconst getInput = () => {\r\n  autocomplete(_base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].input, countries)\r\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].input.value.toLowerCase();\r\n};\r\n\r\nconst clearResults = () => {\r\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].cities.innerHTML = '';\r\n};\n\n//# sourceURL=webpack:///./src/js/view/searchView.js?");
